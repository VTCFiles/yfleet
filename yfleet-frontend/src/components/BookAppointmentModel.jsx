...
const BookAppointmentModal = () => {
    const {isOpen, setIsOpen} = useContext(BookApplointmentContext)
                ...
                {!next && <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none ">
                  ...
                  <div className="relative p-6 flex-auto w-full">
                    ...
                    <form className=''>
                        ...
                        <div className='flex md:space-x-4 mb-4 flex-col md:flex-row space-y-4 md:space-y-0'>
                            <div className='w-full'>
                                <label htmlFor="delivre_le" className='text-sm text-gray-600'>Ou vous etes</label>
                                <input name='delivre_le' type="text" className='border rounded px-3 py-2 border-gray-200 w-full placeholder:text-sm placeholder:text-gray-300' placeholder='Ou vous etes'  />
                            </div>
                            <div className='w-full'>
                                <label htmlFor="expire_le" className='text-sm text-gray-600'>Ou vous voulaiez etre</label>
                                <input name='expire_le' type="text" className='border rounded px-3 py-2 border-gray-200 w-full placeholder:text-sm placeholder:text-gray-300' placeholder='Ou vous voulaiez etre'   />
                            </div>
                        </div>
                    </form>
